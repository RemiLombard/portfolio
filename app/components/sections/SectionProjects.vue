    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div ref="headerRef" class="mb-10 md:mb-16">
        ...
        <p class="text-lg text-dark/60 mt-6 max-w-2xl opacity-0 anim-desc">
          Découvrez une sélection de mes réalisations en communication, design
          graphique et création de contenus digitaux.
        </p>
      </div>
      ...
      <div
        ref="filtersRef"
        class="flex flex-wrap gap-2 md:gap-3 mb-8 md:mb-12 opacity-0"
      >
        <button
      ...
      <div
        v-else
        ref="gridRef"
        class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8"
      >
        <NuxtLink
