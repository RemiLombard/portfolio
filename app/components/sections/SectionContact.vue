  ...
  <section id="contact" ref="sectionRef" class="py-16 md:py-24 bg-cream">
    <div class="max-w-4xl mx-auto px-6">
      ...
      <div ref="headerRef" class="text-center mb-10 md:mb-16">
        <h2 class="section-title text-primary opacity-0 anim-title">
          Travaillons Ensemble
        </h2>
        <p
          class="text-lg text-dark/70 mt-6 max-w-xl mx-auto opacity-0 anim-desc"
        >
          Vous avez un projet en tête ? Vous cherchez un alternant en
          communication / marketing ? N'hésitez pas à me contacter !
        </p>
      </div>
      ...
      <div ref="cardRef" class="card-static max-w-2xl mx-auto opacity-0">
        ...
        <div
          ref="infosRef"
          class="grid sm:grid-cols-2 gap-6 pt-8 border-t-3 border-dark"
        >
          <div class="text-center info-item opacity-0">
            <div
              class="w-12 h-12 mx-auto mb-3 bg-primary border-3 border-dark flex items-center justify-center"
            >
              <svg
                class="w-6 h-6 text-cream-light"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <p
              class="text-xs font-bold uppercase tracking-wider text-dark/50 mb-1"
            >
              Localisation
            </p>
