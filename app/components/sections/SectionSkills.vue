<template>
  <section id="skills" ref="sectionRef" class="py-16 md:py-24 bg-cream-light">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div
        ref="gridRef"
        class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-8 gap-4 md:gap-6 justify-items-center"
      >
        <div
        ...
        >
          ...
          <!-- Tooltip -->
          <div
            class="absolute -bottom-10 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none"
          >
      ...
      <div
        ref="qualitiesRef"
        class="mt-12 md:mt-20 grid md:grid-cols-3 gap-4 md:gap-6"
      >
        <div class="card-static text-center quality-card opacity-0">
          <div
            class="w-16 h-16 mx-auto mb-4 bg-primary flex items-center justify-center border-3 border-dark"
          >
            <svg
              class="w-8 h-8 text-cream-light"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <p class="text-dark/60">
            Toujours à la recherche de nouvelles idées et technologies
          </p>
        </div>
        ...
        <div class="card-static text-center quality-card opacity-0">
          ...
          <p class="text-dark/60">
            Gestion de projet rigoureuse et prise d'initiative
          </p>
        </div>
      </div>
    </div>
