<template>
  <section
    id="experience"
    ref="sectionRef"
    class="py-16 md:py-24 bg-dark text-cream-light relative overflow-hidden"
  >
    <!-- Élément décoratif -->
    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="mb-10 md:mb-16">
        <h2 ref="titleRef" class="section-title text-cream-light opacity-0">
          Mon Expérience
        </h2>
      </div>
      ...
      <div class="grid lg:grid-cols-2 gap-10 md:gap-16">
        ...
        <div ref="expColRef">
          <h3
            class="font-title text-xl uppercase tracking-wider text-primary mb-8 flex items-center gap-3 opacity-0 anim-subtitle"
          >
            <svg
              class="w-6 h-6"
              fill="none"
