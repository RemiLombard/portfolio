<template>
  <div class="min-h-screen bg-cream">
    ...
    >
      ...
      <p class="text-dark/60 mb-8 text-lg">
    ...
    <article v-else>
      ...
      <div class="bg-cream px-6 md:px-12 pb-10 md:pb-16">
        <div class="max-w-6xl mx-auto">
          <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div
              ref="imageRef"
              class="aspect-[4/3] bg-dark/5 overflow-hidden opacity-0"
            >
              <img
              ...
              <div
                v-else
                class="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary/10 to-cream"
              >
                <span class="font-title text-[10rem] text-primary/20">{{
            ...
            <div ref="infoRef">
              <!-- Catégorie -->
              <span
                class="inline-block text-sm font-bold uppercase tracking-widest text-primary mb-4 opacity-0 anim-info"
              >
                {{ categoryLabel }}
              </span>
              ...
              <!-- Titre -->
              <h1
                class="font-title text-4xl md:text-5xl lg:text-6xl text-dark leading-tight mb-6 opacity-0 anim-info"
              >
                {{ project.title }}
              </h1>
              ...
              <!-- Introduction -->
              <p
                class="text-lg md:text-xl text-dark/70 leading-relaxed mb-6 opacity-0 anim-info"
              >
              ...
              <div
                ...
                class="flex flex-wrap gap-3 mt-4 opacity-0 anim-info"
              >
                <span
      ...
      <div class="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div
          ...
          ref="descRef"
          class="py-10 md:py-16 opacity-0"
        >
          <h2
            class="font-title text-2xl md:text-3xl lg:text-4xl text-dark mb-6 md:mb-8"
          >
            À propos du projet
          </h2>
          <div
            class="text-dark/70 leading-relaxed whitespace-pre-line text-lg max-w-3xl"
          >
            {{ project.description }}
          </div>
        </div>
        ...
        >
          <h2
            class="font-title text-2xl md:text-3xl lg:text-4xl text-dark mb-6 md:mb-10 opacity-0 gallery-title"
          >
            Galerie
          </h2>
...
useSeoMeta({
  title: () =>
    project.value
      ? `${project.value.title} | Rémi Lombard`
      : "Projet | Rémi Lombard",
